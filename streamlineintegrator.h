...
protected:
    ...
    std::vector<dvec2> createSingleStreamLine(const VectorField2 &vectorField, const dvec2 &position);
    dvec2 generateRandomStartpoint(const VectorField2 &vectorField, bool isGrid, int grid);
...
public:
    ...
    IntProperty propStepsNum;
    FloatProperty propStepSize;
    FloatProperty propMaxArcLen;
    FloatProperty propMinSpeed;
    TemplateOptionProperty<int> propIntegrationDirection;
    TemplateOptionProperty<int> propIntegrationField;
    IntProperty propRandomLinesNum;
    TemplateOptionProperty<int> propRandomMode;
    IntProperty propGridXNum;
    IntProperty propGridYNum;
