...
public:
    ...
    static dvec2 RK4(const VectorField2& vectorField, const dvec2& position, const double stepSize, bool isBackward, bool isDirectionField);
    static dvec2 Euler(const VectorField2& vectorField, const dvec2& position, const double stepSize, bool isBackward, bool isDirectionField);
};
